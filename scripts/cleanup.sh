...
# Run via cron: 0 4 * * * /home/pi/ai-flower-assistant/scripts/cleanup.sh

WORKSPACE="$HOME/.picoclaw/workspace"
VOICE_DIR="$HOME/ai-flower-assistant/voice-assistant"
LOG="/tmp/ai-flower-cleanup.log"
...
find "$VOICE_DIR" -name "last_input.wav" -mmin +60 -delete 2>/dev/null
